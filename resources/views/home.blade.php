...
<div class="container">
    ...
    <div id="page">
		...
		{{-- <div class="container row border border-warning  bg-warning text-dark" >
			
			<div class="row">
				<div class="col partner-col text-center">
					<img src="system_img/cat1.png" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
				</div>
				<div class="col partner-col text-center">
		...
		<div class="row bg-warning text-dark">
					<div class="col partner-col text-center">
						<img src="system_img/cat1.png" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
						<span class="text-center "><a href="http://"> <kbd>Cat1</kbd> </a> </span>
					</div>
					<div class="col partner-col text-center">
						<img src="system_img/cat2.png" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
						<span class="text-center "><a href="http://"> <kbd>Cat1</kbd> </a> </a> </span>
					</div>
					<div class="col partner-col text-center">
						<img src="system_img/cat3.png" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
						<span class="text-center "><a href="http://"> <kbd>Cat1</kbd> </a> </a> </span>
					...
					{{-- <div class="col partner-col text-center">
						<img src="images/brand-4.jpg" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="images/brand-5.jpg" class="img-fluid rounded-circle" alt="Free html4 bootstrap 4 template">
					</div> --}}
				</div>
